...
public class Expert {
	...
	/** The expertid. */
	@Id
	@NotBlank(message = "Expert Id cannot be blank")
	...
	/** The roles. */
	@NotNull(message="Not be left null")
	...
	public String toString() {
		return "Expert [expertid=" + expertid + ", name=" + name + ", password=" + password + ", specialistIn="
				+ specialistIn + ", issuesids=" + issuesids + ", feedbackids=" + feedbackids + ", roles=" + roles + "]";
	}
