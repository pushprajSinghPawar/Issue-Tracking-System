...
public class Feedback {
	...
	/** The feedbackid. */
	@Id
	@NotBlank(message = "FEED BACK ID CANNOT BE BLANK")
	String feedbackid;
	...
	public String toString() {
		return "Feedback [feedbackid=" + feedbackid + ", userid=" + userid + ", issueid=" + issueid + ", expertid="
				+ expertid + ", feedbackDescription=" + feedbackDescription + ", datefeedbackform=" + datefeedbackform
				+ "]";
	}
