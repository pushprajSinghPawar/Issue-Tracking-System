package com.example.IssueDataMicroservice.model;
...
public class Issue {
	...
	@NotBlank(message = "software Issue Type ID CANNOT BE BLANK")
	String softwareIssueType;
	
	/** The software issue title. */
	@NotBlank(message = "software Issue Title ID CANNOT BE BLANK")
	String softwareIssueTitle;
	
	/** The software issue description. */
	@NotBlank(message = "software Issue Description ID CANNOT BE BLANK")
	...
	/** The userid. */
	@NotBlank(message = "USER ID MUST BE GIVEN")
