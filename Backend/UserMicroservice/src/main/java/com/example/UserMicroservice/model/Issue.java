...
public class Issue {
    ...
    /** The software name. */
    @NotBlank(message = "Software name cannot be filled blank")
	String softwareName;
    
    /** The software issue type. */
    @NotBlank(message = "issuetype cannot be blank")
    @Size(max = 30, message = "Issue  type cannot be more than 20")
	String softwareIssueType;
    
    /** The software issue title. */
    @NotBlank(message = "issue title cannot be blank")
    @Size(max = 30, message = "Issue  Title cannot be more than 30")
	String softwareIssueTitle;

    /** The software issue description. */
    @Size(max = 400, message = "Issue description cannot be more than 400")
